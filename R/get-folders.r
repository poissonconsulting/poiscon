...
{    
  ...
  dir.create(paste0(getOption ("folders.plots_directory"),'/',type,'/',getOption ("folders.plots_folder")),recursive=T,showWarnings=F)    
...
get_tables_folder<-function (type='results')
{
  ...
  dir.create(paste0(getOption ("folders.tables_directory"),'/',type,'/',getOption ("folders.tables_folder")),recursive=T,showWarnings=F)    
