...
get_rdata_folder <- function() {
  ...
  paste0(getOption("folders.rdata_directory"), "/", getOption("folders.rdata_folder"))
}
...
get_analyses_folder <- function() {
  ...
  paste0(getOption("folders.analyses_directory"), "/", getOption("folders.analyses_folder"))
}
...
get_plots_folder <- function(type = "figures") {
  ...
  paste0(getOption("folders.plots_directory"), "/", type, "/", getOption("folders.plots_folder"))
}
...
get_tables_folder <- function(type = "results") {
  ...
  paste0(getOption("folders.tables_directory"), "/", type, "/", getOption("folders.tables_folder"))
} 
